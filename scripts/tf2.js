...
(function() {
  var capitalize, escapeHTML, getAttributes, getDescription, getTags, hide, hideItemBox, init, moveMouse, openSummary, show,
  ...
  window.showItemInfo = function(element) {
    ...
    blueprintsHTML += '</div>';
    buyButton = storePrice ? "<form style='position:absolute;bottom:19px;left:345px;'>$" + storePrice + "<br><input type='text' value='1' size='1' id='quantity' class='textbox'></form><a href='#' id='buy-button'></a>" : '';
