...
(function() {
  var HoverBox, Item, ItemBox, User, ajax, capitalize, escapeHTML, getCookie, postAjax, root, setCookie, _getAjaxRequest,
  ...
  ItemBox = (function() {
    ...
    ItemBox.prototype._pricesLink = function() {
      ...
      if (button && this.item.marketPrice(this.altSource)) {
        button.style.cursor = 'pointer';
        button.onclick = function() {
          _this.altSource = button.innerHTML === 'Spreadsheet' ? 'backpack.tf' : 'spreadsheet';
          button.innerHTML = capitalize(_this.altSource);
