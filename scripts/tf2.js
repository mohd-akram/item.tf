...
(function() {
  ...
  window.showItemInfo = function(item, link) {
    ...
    tagsHTML += "</div>";
    bundleHTML = __indexOf.call(tags, 'bundle') >= 0 && getDescription(item).indexOf('---') !== -1 ? "<a href=\"/search?q=" + item.title + " Set\" target='_blank'><div class='rounded glow' style='display: inline-block; padding: 7px;'>View items</div></a>" : '';
    itemName = item.title;
    if (link) {
