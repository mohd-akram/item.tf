...
a.getAttribute("data-i");this.qualityNo=null!=(c=a.getAttribute("class"))?null!=(e=c.match(/quality-(\d+)/))?e[1]:void 0:void 0;this.elem=a}c.prototype.marketPrice=function(a){return JSON.parse(this.elem.getAttribute("data-"+a))};c.prototype.remove=function(){return this.elem.parentNode.removeChild(this.elem)};return c}();v=function(){function c(a){null==a&&(a=!0);this.showLink=a;this.user=new w;this.itemBox=document.createElement("div");this.itemBox.id="itembox";document.getElementsByTagName("body")[0].appendChild(this.itemBox)}
c.prototype.show=function(a){this.item=new u(a);this.source=this.user.priceSource;this.altSource="spreadsheet"===this.source?"backpack.tf":"spreadsheet";this._generateItemBox();return this.itemBox.style.display="block"};c.prototype.hide=function(){return this.itemBox.style.display="none"};c.prototype._tagsHTML=function(){var a,b,g,c,e,f,h,l,p;if(this.item.tags.length){e="<div id='tags'>";c=0<=k.call(this.item.tags,"weapon");g=0<=k.call(this.item.tags,"token");f=b="";p=["primary","secondary","melee",
"pda2"];h=0;for(l=p.length;h<l;h++)a=p[h],0<=k.call(this.item.tags,a)&&(c?(f=q(a)+" Weapon",b=a):g&&(f="Slot Token",b="slot-token"));l=["hat","misc","tool","bundle"];c=0;for(h=l.length;c<h;c++)a=l[c],0<=k.call(this.item.tags,a)&&(f=q(a),b=a);g&&this.item.classes&&(f="Class Token",b="class-token");f&&b&&(e+="<a href='/search?q="+encodeURIComponent(f)+"'\n target='_blank' title='"+f+"' class='"+b+"'></a>");return e+"</div>"}return""};c.prototype._nameHTML=function(){var a;a=this.item.name;this.showLink&&
(a="<a href='/item/"+this.item.id+"'\n target='_blank' class='glow' title='Go to Item Page'>\n"+a+"</a>");return"<h2 id='itemname'>"+a+"</h2>"};c.prototype._classesHTML=function(){var a,b,c,d,e;if(this.item.classes){a="<div id='classes'>";e=this.item.classes.split(",");c=0;for(d=e.length;c<d;c++)b=e[c],a+="<a href='/search?q="+b+"' target='_blank'\n class='"+b.toLowerCase()+"'></a>";return a+"</div>"}return""};c.prototype._bundleHTML=function(){return 0<=k.call(this.item.tags,"bundle")&&-1!==this.item.description.indexOf("---")?
