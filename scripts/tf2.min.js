...
""};b.prototype._priceSourceHTML=function(){var a,c,b,g,e,f,h;c="";this.item.prices[this.source]||this._nextPriceSource();if(this.item.prices[this.source]){g=Object.keys(this.item.prices[this.source]).sort();f=0;for(h=g.length;f<h;f++){e=g[f];b=this.item.prices[this.source][e];if(a=b.match(/(Refined|Key(s)?|Bud(s)?)/))a=a[0],b=b.replace(/(\d+(\.\d+)?)/g,'<a href="/search?q=$1%20'+a+'"\n target="_blank" class="glow">$1</a>');c+="<span class='"+e.toLowerCase()+"'>"+e+"</span>: "+b+"<br>"}}return c};
b.prototype._pricesHTML=function(){var a;return(a=this._priceSourceHTML())?"<div id='marketprice'><span id='pricesource'>"+n(this.source)+"</span><h3 id='prices'>"+a+"</h3></div>":""};b.prototype._blueprintsHTML=function(){var a,c,b,g,e,f,h,m,q,k,l,n,p,r;if(this.item.blueprints.length){b='<div id="blueprints">';n=this.item.blueprints;h=0;for(k=n.length;h<k;h++){a=n[h];c=a.getAttribute("data-chance");b+='<div class="blueprint">';p=a.getElementsByTagName("li");m=0;for(l=p.length;m<l;m++){a=p[m];q=0;
for(r=a.getAttribute("data-count");0<=r?q<r:q>r;0<=r?++q:--q)f=a.title,g=a.getAttribute("data-index"),e="background-image: url("+a.getAttribute("data-image")+")",e='<div title="'+f+"\" class='item-small' style='"+e+"'></div>",g?g="/item/"+g:(f=f.replace("Any ","").replace("Spy Watch","PDA2 Weapon"),2<f.split(" ").length&&(f=f.replace("Weapon","Set")),g="/search?q="+encodeURIComponent(f)),b+='<a href="'+g+"\" target='_blank'>"+e+"</a>"}b+='<div title="Crafting Chance" style="position: absolute; right: 10px">\n<h3>'+
c+"%</h3></div></div>"}return b+"</div>"}return""};b.prototype._outpostHTML=function(){return'<a href="#" id="find-trades-btn"\n class="icon-exchange icon-large button-icon" title="Find Trades"></a>\n\n<form name="tf2outpostform" method="POST" style="display: inline-block"\n action="http://www.tf2outpost.com/search">\n\n<input type="hidden" name="json">\n<input type="hidden" name="type" value="any">\n<input type="submit" name="submit" value="Search" style="display: none">\n\n<select id="tradetype" class="textbox">\n  <option value="has1">Want</option>\n  <option value="wants1">Have</option>\n</select>\n\n<select id="quality" class="textbox">\n  <option value="6">Unique</option>\n  <option value="3">Vintage</option>\n  <option value="11">Strange</option>\n  <option value="1">Genuine</option>\n  <option value="13">Haunted</option>\n  <option value="5">Unusual</option>\n</select>\n\n</form>'};
...
document.getElementById("quantity"),(b.onchange=function(){return a.href="http://store.steampowered.com/buyitem/440/"+d.item.id+"/"+b.value})()};b.prototype._generate=function(){var a,b,d,g,e,f;this.elem.innerHTML=""+this._tagsHTML()+this._nameHTML()+this._classesHTML()+"\n"+this._bundleHTML()+"\n"+this._pricesHTML()+"\n"+this._blueprintsHTML()+"\n"+this._buttonsHTML()+this._buyHTML();this.form=document.tf2outpostform;this._pricesLink();this._outpostLink();this._wishlistLink();this._buyLink();a=this.item.elem.cloneNode(!0);
a.id="hoverarea";a.className="";a.setAttribute("style","background-image: url("+this.item.imageUrl+")");this.elem.insertBefore(a,document.getElementById("blueprints")||document.getElementById("buttons"));new t(a);if(this.item.qualityNo)return this.form.quality.value=this.item.qualityNo;if(this.item.prices[this.source]){e=this.form.quality.options;f=[];a=d=0;for(g=e.length;d<g;a=++d)if(b=e[a],b.innerHTML in this.item.prices[this.source]){this.form.quality.selectedIndex=a;break}else f.push(void 0);
return f}};return b}();t=function(){function b(a,b){this.itemBox=b;this._clickItem=p(this._clickItem,this);this._moveMouse=p(this._moveMouse,this);this._hideItemBox=p(this._hideItemBox,this);this._hide=p(this._hide,this);this._show=p(this._show,this);a instanceof v&&(this.itemBox=a,a=null);this.elem=document.getElementById("hoverbox");this.elem||(this.elem=document.createElement("div"),this.elem.id="hoverbox",document.body.appendChild(this.elem));this._add(a)}b.prototype._add=function(a){var b,d,
g,e=this;b=a?[a]:document.getElementsByClassName("item");d=0;for(g=b.length;d<g;d++)a=b[d],a.addEventListener("mouseout",this._hide,!1),a.addEventListener("mousemove",this._moveMouse,!1),a.addEventListener("mouseover",this._show,!1),this.itemBox&&a.addEventListener("click",this._clickItem,!1);if(this.itemBox)return document.addEventListener("click",this._hideItemBox,!1),document.onkeydown=function(a){if(27===a.keyCode)return e.itemBox.hide()}};b.prototype._show=function(a){var b;a=new u(a.target);
